...
def toy_datasets_section():
    ...
    datasets = [
        {"Name": "load_iris", "Task": "Classification", "Samples": 150, "Features": 4, "Description": "Flower species classification"},
        {"Name": "load_digits", "Task": "Classification", "Samples": 1797, "Features": 64, "Description": "Handwritten digit recognition"},
        {"Name": "load_wine", "Task": "Classification", "Samples": 178, "Features": 13, "Description": "Wine cultivar classification"},
        {"Name": "load_breast_cancer", "Task": "Classification", "Samples": 569, "Features": 30, "Description": "Tumor malignancy classification"},
        {"Name": "load_diabetes", "Task": "Regression", "Samples": 442, "Features": 10, "Description": "Disease progression prediction"},
        {"Name": "load_linnerud", "Task": "Multioutput", "Samples": 20, "Features": 3, "Description": "Physical exercise dataset"},
    ]
...
def real_world_section():
    ...
    datasets = [
        {"Name": "fetch_california_housing", "Task": "Regression", "Samples": "20,640", "Description": "California house prices"},
        {"Name": "fetch_covtype", "Task": "Classification", "Samples": "581,012", "Description": "Forest cover type"},
        {"Name": "fetch_kddcup99", "Task": "Classification", "Samples": "4.9M", "Description": "Network intrusion detection"},
        {"Name": "fetch_20newsgroups", "Task": "Text Classification", "Samples": "~18,000", "Description": "Newsgroup documents"},
        {"Name": "fetch_lfw_people", "Task": "Face Recognition", "Samples": "13,233", "Description": "Labeled faces in the wild"},
        {"Name": "fetch_olivetti_faces", "Task": "Face Recognition", "Samples": "400", "Description": "Olivetti faces"},
    ]
